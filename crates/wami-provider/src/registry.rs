...
mod tests {
    ...
    impl CloudProvider for DummyProvider {
        ...
        fn generate_resource_identifier(
            &self,
            _resource_type: crate::ResourceType,
            _account_id: &str,
            _path: &str,
            name: &str,
        ) -> String {
        ...
        fn generate_resource_id(&self, _resource_type: crate::ResourceType) -> String {
            "id".to_string()
        }

        fn resource_limits(&self) -> &crate::ResourceLimits {
            static LIMITS: crate::ResourceLimits = crate::ResourceLimits {
    ...
    fn register_and_get_provider() {
        ...
        assert_eq!(
            fetched.generate_resource_identifier(crate::ResourceType::User, "", "", "alice"),
            "alice"
        );
    }
