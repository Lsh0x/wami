...
// Re-export core primitives from the dedicated crate
pub use wami_core::arn;
pub use wami_core::context;
pub use wami_core::error;
pub use wami_core::types;

// Re-export main types for convenience
pub use wami_core::error::{AmiError, OptionExt, Result};
pub use wami_core::types::{
    AmiResponse, AwsConfig, PaginationParams, PolicyDocument, PolicyStatement, Tag,
};
...
pub use wami_provider as provider;
...
// pub use credentials::server_certificate::ServerCertificateMetadata; // TODO: fix path
...
pub use credentials::access_key::{
    AccessKeyLastUsed, CreateAccessKeyRequest, ListAccessKeysRequest, ListAccessKeysResponse,
    UpdateAccessKeyRequest,
};
pub use credentials::login_profile::{
    CreateLoginProfileRequest, GetLoginProfileRequest, UpdateLoginProfileRequest,
};
pub use credentials::mfa_device::{EnableMfaDeviceRequest, ListMfaDevicesRequest};
pub use credentials::server_certificate::{
...
pub use credentials::service_credential::{
...
pub use credentials::signing_certificate::{
