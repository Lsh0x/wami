...
impl<T> CredentialReportServiceStore for T where
    T: CredentialReportStore
        + UserStore
        + GroupStore
        + RoleStore
        + PolicyStore
...
#[wami_macros::service(
    store_trait = "crate::service::reports::credential_report::CredentialReportServiceStore",
    generate_new = false
)]
...
where
    S: CredentialReportServiceStore,
{
