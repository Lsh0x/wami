...
pub trait StsStore: Send + Sync {
    ...
    async fn create_session(
        &mut self,
        session: crate::sts::StsSession,
    ) -> Result<crate::sts::StsSession>;
    ...
    async fn create_identity(
        &mut self,
        identity: crate::sts::CallerIdentity,
    ) -> Result<crate::sts::CallerIdentity>;
...
pub trait SsoAdminStore: Send + Sync {
    async fn create_permission_set(
        &mut self,
        permission_set: crate::sso_admin::PermissionSet,
    ) -> Result<crate::sso_admin::PermissionSet>;
    async fn get_permission_set(
        &self,
        permission_set_arn: &str,
    ) -> Result<Option<crate::sso_admin::PermissionSet>>;
    ...
    async fn list_permission_sets(
        &self,
        instance_arn: &str,
    ) -> Result<Vec<crate::sso_admin::PermissionSet>>;

    async fn create_account_assignment(
        &mut self,
        assignment: crate::sso_admin::AccountAssignment,
    ) -> Result<crate::sso_admin::AccountAssignment>;
    async fn get_account_assignment(
        &self,
        assignment_id: &str,
    ) -> Result<Option<crate::sso_admin::AccountAssignment>>;
    async fn delete_account_assignment(&mut self, assignment_id: &str) -> Result<()>;
    async fn list_account_assignments(
        &self,
        account_id: &str,
        permission_set_arn: &str,
    ) -> Result<Vec<crate::sso_admin::AccountAssignment>>;

    async fn create_instance(
        &mut self,
        instance: crate::sso_admin::SsoInstance,
    ) -> Result<crate::sso_admin::SsoInstance>;
    async fn get_instance(
        &self,
        instance_arn: &str,
    ) -> Result<Option<crate::sso_admin::SsoInstance>>;
    async fn list_instances(&self) -> Result<Vec<crate::sso_admin::SsoInstance>>;

    async fn create_application(
        &mut self,
        application: crate::sso_admin::Application,
    ) -> Result<crate::sso_admin::Application>;
    async fn get_application(
        &self,
        application_arn: &str,
    ) -> Result<Option<crate::sso_admin::Application>>;
    async fn list_applications(
        &self,
        instance_arn: &str,
    ) -> Result<Vec<crate::sso_admin::Application>>;

    async fn create_trusted_token_issuer(
        &mut self,
        issuer: crate::sso_admin::TrustedTokenIssuer,
    ) -> Result<crate::sso_admin::TrustedTokenIssuer>;
    async fn get_trusted_token_issuer(
        &self,
        issuer_arn: &str,
    ) -> Result<Option<crate::sso_admin::TrustedTokenIssuer>>;
    async fn delete_trusted_token_issuer(&mut self, issuer_arn: &str) -> Result<()>;
    async fn list_trusted_token_issuers(
        &self,
        instance_arn: &str,
    ) -> Result<Vec<crate::sso_admin::TrustedTokenIssuer>>;
}
